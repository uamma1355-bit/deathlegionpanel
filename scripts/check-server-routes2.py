#!/usr/bin/env python3
"""Check how server routes are registered + test the actual endpoint."""
import json
...
body = json.dumps({
    "command": "cd /home/daytona/backend && grep -B 2 -A 5 'servers/{server}' routes/api-client.php | head -20",
    "cwd": "/home/daytona",
    "timeout": 15,
})
