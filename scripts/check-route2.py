#!/usr/bin/env python3
"""Check the actual {server} route binding implementation."""
import json
...
body = json.dumps({
    "command": "cd /home/daytona/backend && grep -A 20 'registerRouteBindings' app/Providers/RouteServiceProvider.php | head -30",
    "cwd": "/home/daytona",
    "timeout": 15,
})
