...
<div class="dl-nav-icons">
  ...
  <a href="/ads" class="dl-nav-icon" title="Watch Ads for Credits" style="background:rgba(188,110,60,0.15);border-color:rgba(188,110,60,0.4);color:#e89060">
    <svg viewBox="0 0 24 24"><path d="M21 3H3c-1.11 0-2 .89-2 2v12c0 1.1.89 2 2 2h5v2h8v-2h5c1.1 0 1.99-.9 1.99-2L23 5c0-1.11-.9-2-2-2zm0 14H3V5h18v12zm-5-6l-7 4V7z"/></svg>
    <span class="tooltip">Watch Ads +50cr</span>
  </a>
  <div class="dl-credit-badge" id="dlCreditBadge" style="cursor:pointer" onclick="window.location.href='/ads'">
    <span class="dot"></span>
