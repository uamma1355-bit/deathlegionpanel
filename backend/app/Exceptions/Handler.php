...
class Handler extends ExceptionHandler
{
    ...
    protected function unauthenticated($request, AuthenticationException $exception): JsonResponse|RedirectResponse
    {
        ...
        // In the decoupled backend the Blade `/auth/login` route is gone.
        // Redirect unauthenticated web visitors to the operator-configured
        // frontend login URL, defaulting to the admin area.
        return redirect()->guest(env('FRONTEND_LOGIN_URL', '/admin'));
    }
